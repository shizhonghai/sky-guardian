...
const TabBar = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-teal-950/80 backdrop-blur-xl border-t border-white/10 pb-safe pt-2 px-6 h-20 flex justify-between items-start z-50 shadow-[0_-4px_20px_rgba(0,0,0,0.2)]">
